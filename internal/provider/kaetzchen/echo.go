...
// EchoCapability is the standardized capability for the loop/discard service.
const EchoCapability = "loop"
...
// NewEcho constructs a new Echo Kaetzchen instance, providing the "loop"
